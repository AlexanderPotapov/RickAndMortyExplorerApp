        ...
        return try await withCheckedThrowingContinuation { continuation in
            ...
            SDWebImageManager.shared.loadImage(
                ...
                completed: { image, _, error, _, _, _ in
                    // Защищаемся от многократного вызова completion handler
                    ...
                    if let error = error {
                        ...
                        continuation.resume(throwing: NSError(domain: "ImageDownloadError", code: -1, userInfo: [NSLocalizedDescriptionKey: "Не удалось загрузить изображение"]))
                    }
                }
            )
        }
