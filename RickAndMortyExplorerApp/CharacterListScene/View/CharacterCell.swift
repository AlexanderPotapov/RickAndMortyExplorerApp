...
final class CharacterCell: UITableViewCell {
    ...
    override func prepareForReuse() {
        ...
        // Сбрасываем трансформацию при переиспользовании ячейки
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            backgroundColorView.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 4),
            ...
            backgroundColorView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -4),
            
            characterImageView.leadingAnchor.constraint(equalTo: backgroundColorView.leadingAnchor, constant: 8),
            ...
            nameLabel.topAnchor.constraint(equalTo: backgroundColorView.topAnchor, constant: 12),
            nameLabel.trailingAnchor.constraint(equalTo: backgroundColorView.trailingAnchor, constant: -16),
            ...
            speciesLabel.trailingAnchor.constraint(equalTo: backgroundColorView.trailingAnchor, constant: -16),
            speciesLabel.bottomAnchor.constraint(lessThanOrEqualTo: backgroundColorView.bottomAnchor, constant: -12)
        ])
