...
final class CharacterListView: UIView {
    ...
    private lazy var statusSegmentControl: UISegmentedControl = {
        ...
        segmentControl.addTarget(self, action: #selector(statusFilterChanged), for: .valueChanged)
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            statusSegmentControl.topAnchor.constraint(equalTo: searchBar.bottomAnchor, constant: 8),
            statusSegmentControl.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 16),
            statusSegmentControl.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -16),
            
            tableView.topAnchor.constraint(equalTo: statusSegmentControl.bottomAnchor, constant: 8),
            ...
            emptyStateView.topAnchor.constraint(equalTo: statusSegmentControl.bottomAnchor, constant: 8),
